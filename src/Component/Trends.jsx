...
function Trends() {
  ...
  const movies =[
    {id:1,movie:bison},{id:2,movie:dude},{id:3,movie:idlikadai},{id:4,movie:jolly},{id:5,movie:og},{id:6,movie:narasimha}, {id:7,movie:delhicrime},{id:8,movie:stranger},{id:8,movie:kurukshethra},]
  return (
    <>
      <div className='pt-10'>
        ...
        <div className='flex gap-10 w-full  border-white overflow-scroll hide-scrollbar  '>
          {
            movies.map((movie, index) => (
              <div key={index} className='pt-5 relative flex flex-now '>
